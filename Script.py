class script(object):
    START_TXT = """<b>හෙලෝ {},
මම <a href=https://t.me/{}>{}</a>, ඔයාට ඕන ෆිල්ම් , ටීවී සීරියස් වලට සිංහල සබ්ටයිට්ල් හොයලා දෙන්න මට පුලුවන්. මාව ගෲප් එකකට ඇඩ් කරලා ඇඩ්මින් දෙන්න..😍</b>"""
    HELP_TXT = """Hey {}
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/GT_Bots)</code>
