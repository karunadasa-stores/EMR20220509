...
BOT_TOKEN = '2037096447:AAFWSo_F_u1wPrGSjNdQ4TQ8t2ZgjT9wLxM'
...
ADMINS = [1376213565]
CHANNELS = [-1001589735155]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = '-1001590852342'
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>We found It :\n</b>{query}")
